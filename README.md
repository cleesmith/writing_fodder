...
- You can expect to wait a few minutes for the writing process to complete<br> &nbsp;&nbsp;&nbsp;*my average wait is about 1 minute 30 seconds; it also depends:<br> &nbsp;&nbsp;&nbsp;*on your network connection, your API Tier level, and Claude's moodiness*
